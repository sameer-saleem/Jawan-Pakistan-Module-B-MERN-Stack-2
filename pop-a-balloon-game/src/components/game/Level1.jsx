// src/components/game/Level1.jsx
...
export default function Level1({ onLevelComplete }) {
  ...
  // Inside Level1.jsx → endGame function
const endGame = (won) => {
  setGameOver(true);
  ...
  // THIS IS THE FIX — always send targetColor.name, even on failure!
  ...
  setTimeout(() => {
    onLevelComplete({
      ...
      avgReactionTime: avg,
      targetColor: finalTargetColorName,   // ← FIXED: always defined
      livesLeft: lives,                    // ← optional: how many lives left
      level: 1,                           // ← ADD: level number
    });
  }, 1200);
};
